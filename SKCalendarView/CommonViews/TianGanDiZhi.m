...
#import "TianGanDiZhi.h"

@implementation TianGanDiZhi
...
- (NSString *)tianDiDay:(NSDate *)time{
    NSDateComponents * comps = [[NSDateComponents alloc] init];
    NSInteger unitFlags = NSCalendarUnitDay | NSCalendarUnitWeekday | NSCalendarUnitMonth | NSCalendarUnitYear;
...
//    NSString *yearOfTianDi = FormatString(@"%@%@", [self.tian valueForKey:[NSString stringWithFormat:@"%ld",indexTian]], [self.di valueForKey:[NSString stringWithFormat:@"%ld", indexDi]]);
    ...
    z = z % 12;
//    NSString *c = FormatString(@"%@%@", [self.tian valueForKey:[NSString stringWithFormat:@"%d", g]], [self.di valueForKey:[NSString stringWithFormat:@"%d", z]]); //得到日的天干地支
    NSString *c = [NSString stringWithFormat:@"%@%@", [self.tian valueForKey:[NSString stringWithFormat:@"%d", g]], [self.di valueForKey:[NSString stringWithFormat:@"%d", z]]];
    //计算月的天干地支
//    NSString *strMonth = FormatString(@"%ld月", month);
    ...
    NSString *shenXiao = [self getShengxiao:time];
    NSString *result = @"";
    if ([self.monthTable.allKeys containsObject:strMonth]) {
        ...
        result = [NSString stringWithFormat:@"%@%@年 %@ %@日", yearOfTianDi, shenXiao, [stmpMonth valueForKey:[NSString stringWithFormat:@"%ld", indexOfmonth]], c];
    } else {
        result = @"输入的月份不存在";
    }
    return result;
